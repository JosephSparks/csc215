...
START:  LDA     VAL1   ; Load value (5) at VAL1 (200o) into Accumulator
        MOV     B,A    ; Move value in Accumulator to Register B
        LDA     VAL2   ; Load value (8) at VAL2 (201o) into Accumulator
        ADD     B      ; Add value in Register B to value in Accumulator
        STA     SUM    ; Store accumulator at SUM (202o)
        JMP     START  ; Jump to start of code (infinite loop)

; Data segment:

        ORG     200o   ; Set Program Counter to address 200o
